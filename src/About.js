...
function About() {
  return (
    <AboutText>
      ...
      <p>I make <a href="https://technofantasy.itch.io" target='_blank'>games</a> and <a href='https://github.com/mikeleisz/gud_gbs_plugins' target='_blank'>gamedev tools</a> and for Game Boy hardware, and moderate the <a href='https://www.gbstudio.dev' target='_blank'>Game Boy Studio</a> discord community.</p>
